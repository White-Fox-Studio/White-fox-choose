...
export const ThDictionary: IDictionary = {
  languageSign: 'TH',
  formTitle: 'กรอกรายละเอียดการสั่งซื้อ',
  formOrderNumberPlaceholder: 'หมายเลขสั่งซื้อ',
  formOrderNumberError: 'ต้องมีหมายเลขสั่งซื้อ',
  formStudentLastNamePlaceholder: 'นามสกุลนักเรียน',
